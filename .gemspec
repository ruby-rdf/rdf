...
GEMSPEC = Gem::Specification.new do |gem|
  ...
  gem.files              = %w(AUTHORS README UNLICENSE VERSION) + Dir.glob('bin/rdf*') + Dir.glob('lib/**/*.rb')
  gem.bindir             = %q(bin)
  gem.executables        = %w(rdf rdf-count rdf-lengths rdf-objects rdf-predicates rdf-subjects)
