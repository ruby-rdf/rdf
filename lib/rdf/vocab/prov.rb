...
Archives/Public/public-prov-comments/). All feedback is welcome.).freeze,
      ...
      "owl:imports" => %(http://www.w3.org/ns/prov-aq#).freeze,
      "owl:versionIRI" => %(http://www.w3.org/ns/prov-20130430).freeze,
      "prov:specializationOf" => %(http://www.w3.org/ns/prov-o-inverses).freeze,
      "prov:wasDerivedFrom" => %(http://www.w3.org/ns/prov-aq#).freeze,
      "prov:wasRevisionOf" => %(http://www.w3.org/ns/prov-20130312).freeze,
      "rdfs:isDefinedBy" => %(http://www.w3.org/ns/prov).freeze,
      "rdfs:seeAlso" => %(http://www.w3.org/TR/prov-overview/).freeze,
